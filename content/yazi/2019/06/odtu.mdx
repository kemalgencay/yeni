...
yapısına bağlıyorum. Carl Sagan da böyle idi, bir söyleşisinde soruyorlar ESP (Extra Sensory Percetion) hakkında
...
Bu yazımı daha fazla uzatmadan, çeşitli konulardakı görüşlerimi Görüşlerim başlığı altındaki liste bulabilirsiniz.
